/* Firebase: localhost usa exclusivamente emuladores e projeto demo. Veja README.md. */
(function (global) {
  "use strict";
  ...
  if (isLocalhost) {
    firebaseConfig.projectId = "demo-coding-loop";
    firebaseConfig.apiKey = "demo-key";
    firebaseConfig.authDomain = "demo-coding-loop.firebaseapp.com";
  }
